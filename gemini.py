...
def extract_steps(text):
    ...
    # steps = generate(
    "I am kinda feeling a spicy dish. I have a couple tomatoes and some rice in the fridge and I want to use it. I am alergic to nuts. I want to eat something tasty that I can make with low effort."
...
def extracted(pref):
    return extract_steps(generate(pref))
